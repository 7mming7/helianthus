...
public class YearBillEmailSendJob extends AbstractExecutableJob {
    ...
    public boolean execute(JobExecutionContext context) {
        IEmailSenderService iEmailSenderService = (IEmailSenderService)SpringUtils.getBean(IEmailSenderService.class);
        YearBillMailRecordRepository yearBillMailRecordRepository = (YearBillMailRecordRepository)SpringUtils.getBean(YearBillMailRecordRepository.class);
