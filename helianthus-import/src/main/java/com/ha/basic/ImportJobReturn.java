 ...
 * | o| (_
 */
public class ImportJobReturn implements Serializable {
     ...
     * Job执行返回值, 默认0。
     */
    private int returnCode = ImportSystemReturnCode.SUCCESS;
     ...
     * 异常组，默认200
     */
    private int errorGroup = ImportSystemReturnCode.SUCCESS;
     ...
     * @see ImportSystemReturnCode
     */
    public ImportJobReturn() {}
     ...
     */
    public ImportJobReturn(String returnMsg) {
        this.returnMsg = returnMsg;
    }

    public ImportJobReturn(int returnCode, String returnMsg, int errorGroup) {
    ...
    public String toString() {
        return "ImportJobReturn [returnCode=" + returnCode + ", returnMsg=" + returnMsg + ", errorGroup=" + errorGroup
                + ", prop=" + prop + "]";
    }
