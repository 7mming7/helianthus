package com.ha.quartz.service;

import com.ha.quartz.model.AbstractExecutableJob;
...
import com.ha.quartz.quartz.QuartzJobFactory;
...
public class QuartzScheduleService {
    ...
    public boolean addJob(AbstractExecutableJob job) {
        try {
            SchedulerFactoryBean schedulerFactoryBean = SpringUtils.getBean(SchedulerFactoryBean.class);
